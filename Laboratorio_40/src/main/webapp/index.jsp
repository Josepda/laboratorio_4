                ...
                <table class="table table-bordered table-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=n.getEdad()%></td>
                            <td>
                                <i class="ti ti-eye" onclick="verPerro('<%=n.getNombre()%>')"></i>
                                <i class="ti ti-pencil" onclick="editarPerro('<%=n.getNombre()%>')"></i>
                                <i class="ti ti-trash" onclick="eliminarPerro('<%=n.getNombre()%>')"></i>
                            </td>
